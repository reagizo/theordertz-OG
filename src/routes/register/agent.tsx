          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="sm:col-span-2">
                <label className="block text-sm font-semibold text-white/80 mb-1.5">Physical Address *</label>
                <div className="relative">
              ...
              <div className="sm:col-span-2">
                <label className="block text-sm font-semibold text-white/80 mb-1.5">Business Name (Optional)</label>
                <div className="relative">
